...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	...
	if (isset($_POST['update_profile'])) {
		...
		$profile_errors = validate_user_fields($first_name, $last_name, $email, $phone, $username);
        ...
        <div class="profile-sections">
          ...
          <section class="profile-section">
            ...
            <form action="/profile.php" method="post" id="password-form">
              ...
              <label for="new_password">New Password <span class="required">*</span></label><br>
              <input type="password" id="new_password" name="new_password"
                minlength="8" required autocomplete="new-password"><br>

              <label for="confirm_password">Confirm New Password <span class="required">*</span></label><br>
